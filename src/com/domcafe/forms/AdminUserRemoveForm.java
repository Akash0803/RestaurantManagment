 ...
 * @author admin
 */
public class AdminUserRemoveForm extends javax.swing.JFrame {
         DBClass db=new DBClass();
    /**
     * Creates new form LoginForm
     */
    public AdminUserRemoveForm() {
        initComponents();
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
             try {
                 ...
                 if(rs.next()){
                     ...
                     UserDeleteForm f=new UserDeleteForm();
                    f.setVisible(true);
                     
                 }else{
                     Utility.showWarn("Invalid UserName or Password... try again", "Login Failed");
                 }} catch (SQLException ex) {
                 Logger.getLogger(AdminUserRemoveForm.class.getName()).log(Level.SEVERE, null, ex);
             }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminUserRemoveForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminUserRemoveForm().setVisible(true);
            }
        });
    }
