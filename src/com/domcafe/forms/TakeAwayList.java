 ...
 * @author admin
 */
public class TakeAwayList extends javax.swing.JFrame {
    ...
    public TakeAwayList() {
        ...
        getRootPane().setBorder(BorderFactory.createEtchedBorder());
          db.fillTable(table1, "select * from TakeAway");
            db.applySearch(table1, cmbsearch, txtsearch, "select * From TakeAway");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Take Away List/Home Delivery List");
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Date", "Type", "Customer Name", "Address", "Mobile", "Disc %", "Disc Amt", "Pay Mode", "Total Amt", "Net Amt"
            }
        ) {
        ...
        cmbsearch.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BillNo", "InvoiceDate", "Type", "Name", "Mobile" }));
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(i!=-1){            
            if(Utility.showConfirm("Delete selected Invoice?", "Confirm Delete")==0){
                ...
                db.execute("delete from Takeaway where BillNo=?", no);
                db.fillTable(table1, "select * from Takeaway");
            }
        }else{
    ...
    private void bnteditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnteditActionPerformed
        ...
        if(i!=-1){
            ...
            map.put("p1", roll);
            db.showReport("src/Reports/Invoice_1.jrxml",map);
    ...
    private void bntedit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntedit1ActionPerformed
        ...
        if(i!=-1){            
           ...
           TakeAwayEditForm.parent=this;
           TakeAwayEditForm f=new TakeAwayEditForm();
           f.setData(billno);
           f.setVisible(true);
        }else{
    ...
    private void bntedit2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntedit2ActionPerformed
      TakeAwayForm f=new TakeAwayForm();
      f.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TakeAwayList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TakeAwayList().setVisible(true);
            }
        });
    }
