 ...
 * @author admin
 */
public class SupplyProviderForm extends javax.swing.JFrame {
         DBClass db=new DBClass();
         String oldname;
    /**
     * Creates new form LoginForm
     */
    public SupplyProviderForm() {
        initComponents();
        getContentPane().setBackground(new Color(255,255,204));
        Utility.resizeLabelImage(lblim);
        getRootPane().setBorder(BorderFactory.createEtchedBorder());
         getRootPane().setDefaultButton(btnsave);
          db.fillTable(table1, "select * from branch");
    ...
    private void initComponents() {
        ...
        Branch.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
              ...
              if(txtname.getText().equals(""))
        {
            ...
            if(btntext.equals("Save")){
                db.execute("Insert into branch values(?)", name);
                Utility.showMsg("Supply Provider entry is..","Saved");
                txtname.setText("");
            }else{
                db.execute("Update branch set Supply Provider=? where Supply Provider=?", name,oldname);
                Utility.showMsg("Supply Provider entry is updated..","Updated");
                btnsave.setText("Save");
                txtname.setText("");
            }
            db.fillTable(table1, "select * from branch");
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(i!=-1){              
        int ans=Utility.showConfirm("Do you want to remove selected Raw material entry?","Confirm");
        if(ans==JOptionPane.YES_OPTION){            
        Object name=table1.getValueAt(i, 0);
        db.execute("delete from branch where Supply Provider=?", name);
        db.fillTable(table1, "select * from branch");
        }
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SupplyProviderForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SupplyProviderForm().setVisible(true);
            }
        });
    }
