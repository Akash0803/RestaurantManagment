 ...
 * @author admin
 */
public class MralForm extends javax.swing.JFrame {
    ...
    public MralForm() {
        ...
        getRootPane().setBorder(BorderFactory.createEtchedBorder());
         getRootPane().setDefaultButton(btnsave);
          db.fillTable(table1, "select * from rawitems");
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
                  ...
                  if(txtname.getText().equals(""))
        {
            ...
            if(btntext.equals("Save")){
                db.execute("Insert into rawitems values(?)", name);
                Utility.showMsg("Raw material entry is..","Saved");
                txtname.setText("");
            }else{
                db.execute("Update rawitems set RawItem=? where RawItem=?", name,oldname);
                Utility.showMsg("Raw material entry is updated..","Updated");
                btnsave.setText("Save");
                txtname.setText("");
            }
            db.fillTable(table1, "select * from rawitems");
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        db.execute("delete from rawitems where RawItem=?", name);
        db.fillTable(table1, "select * from rawitems");
        }
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MralForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
