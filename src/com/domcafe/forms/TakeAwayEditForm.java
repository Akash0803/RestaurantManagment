 ...
 * @author admin
 */
public class TakeAwayEditForm extends javax.swing.JFrame {
         DBClass db=new DBClass();
    public static TakeAwayList parent;
    /**
     * Creates new form LoginForm
     */
    public TakeAwayEditForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Take Away/Home Delivery Bill Edit");
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addGap(32, 32, 32)
                                .addComponent(txtdate2, javax.swing.GroupLayout.PREFERRED_SIZE, 213, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
   ...
   public void setData(String billno){
        try{
        ResultSet rs=db.getData("select * from takeaway where BillNo=?",billno);
        if(rs.next()){
            ...
            db.fillTable(tab3, "select ItemNo,ItemName,Qty,gst,Price,Total From takeawayitem where BillNo=?",billno);
        }
        }catch(Exception ex){
            ex.printStackTrace();
        }
    ...
    private void btnSave2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSave2ActionPerformed
        ...
        //Master Record Entry
        db.execute("Update Takeaway set InvoiceDate=?,Type=?,Name=?,Address=?,Mobile=?,DisP=?,DisAmt=?,Total=?,NetAmt=? where BillNo=?",qdate,type,customer,address,mobile,discp,discamt,tamt,namt,billno);
        ...
        for(int i=0;i<tab3.getRowCount();i++){
            ...
            db.execute("Update takeawayitem Set ItemNo=?,ItemName=?,Qty=?,gst=?,Price=?,Total=? where BillNo=?",itemno,itemname,qty,gst,price,total,billno);
        }
        //Update ID
...
//        db.fillTable(parent.table1, "select * Invoice");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TakeAwayEditForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TakeAwayEditForm().setVisible(true);
            }
        });
    }
